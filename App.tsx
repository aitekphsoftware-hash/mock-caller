                    ...
                    <footer className="w-full flex flex-col items-center justify-center flex-shrink-0 p-4">
                        {isConversationActive ? (
                            <>
                                ...
                                <button onClick={confirmAndEndCall} className="w-16 h-16 bg-red-600 rounded-full text-white flex items-center justify-center" aria-label="End Call">
